    ...
    <div className="min-h-screen flex items-center justify-center px-4 pt-20 pb-16">
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-[#888888] text-sm mt-2">Sign in to your PRISM account</p>
        </div>

        <div className="bg-[#1a1a1a] border border-[#2e2e2e] rounded-sm p-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-[#888888] text-xs tracking-[0.2em] uppercase mb-2">Email</label>
              <input
                type="email"
                value={email}
            ...
            <div>
              <label className="block text-[#888888] text-xs tracking-[0.2em] uppercase mb-2">Password</label>
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full bg-[#0a0a0a] border border-[#2e2e2e] text-white text-sm px-4 py-3 pr-12 focus:outline-none focus:border-white transition-colors rounded-sm"
                />
                <button
                  type="button"
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center">
              <span className="bg-[#1a1a1a] px-3 text-[#888888] text-xs">OR</span>
            </div>
          </div>

          <button
            onClick={() => signIn("google", { callbackUrl })}
            className="w-full border border-[#2e2e2e] text-[#888888] py-4 text-sm tracking-[0.2em] uppercase hover:border-white hover:text-white transition-colors flex items-center justify-center gap-3"
          >
        ...
        <p className="text-center text-[#888888] text-sm mt-6">
          ...
          <Link href="/register" className="text-white underline underline-offset-4 hover:text-[#c0c0c0] transition-colors">
            Register
          </Link>
        </p>
      </motion.div>
